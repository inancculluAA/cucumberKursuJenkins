...
/**
 * Verilen Exceldeki password bilgisini bir metod aracılığı bularak yazdırınız,
...
public class _05_GetASpecificData {
    ...
    public static String bul(String aranKelime) {
        ...
        for (int i = 0; i < sheet.getPhysicalNumberOfRows(); i++) {
            ...
            if (cell.toString().equalsIgnoreCase(aranKelime))
